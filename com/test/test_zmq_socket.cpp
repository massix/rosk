...
void client()
{
	...
	rosk::com::login_message & rlogin = rmsg.access_internal_message<rosk::com::login_message>();
...
bool server()
{
	...
	rosk::com::rosk_message rmsg(zmq_socket);
	zmq_socket.close();

	rosk::com::login_message const & rlogin = rmsg.get_internal_message<rosk::com::login_message>();
